...
@app.route("/visits")
def visits():
    field_names = ['alertcount', 'field', 'firstseen', 'lastseen']
    visit_ids = redis_conn.zrevrangebyscore("visits", "+inf", "-inf", start=0, num=10)
    combined_visits = []
    for visit_id in visit_ids:
        ...
        for field_name in field_names:
            ...
            visit_out[field_name] = str(redis_conn.get(field_string), 'utf-8')
            if field_name == 'field':
